...
# Download GitHub CLI
gh_cli_url=$(resolve_github_release_asset_url "cli/cli" "contains(\"linux\") and contains(\"$(get_arch "amd64" "arm64")\") and endswith(\".deb\")" "latest")
...
external_hash=$(get_checksum_from_url "$hash_url" "linux_$(get_arch "amd64" "arm64").deb" "SHA256")
