...
minikube_binary_path=$(download_with_retry "https://storage.googleapis.com/minikube/releases/${minikube_version}/minikube-linux-$(get_arch "amd64" "arm64")")

# Supply chain security - Minikube
minikube_hash=$(get_checksum_from_github_release "kubernetes/minikube" "linux-$(get_arch "amd64" "arm64")" "${minikube_version}" "SHA256")
