...
# Download yq
yq_url=$(resolve_github_release_asset_url "mikefarah/yq" "endswith(\"yq_linux_$(get_arch "amd64" "arm64")\")" "latest")
...
external_hash=$(get_checksum_from_url "${hash_url}" "yq_linux_$(get_arch "amd64" "arm64") " "SHA256" "true" " " "19")
