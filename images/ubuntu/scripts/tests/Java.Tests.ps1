...
Describe "Java" {
    ...
    It "Java <DefaultJavaVersion> is default" -TestCases @{ DefaultJavaVersion = $defaultVersion } {
        ...
        $expectedJavaPath = [System.Environment]::GetEnvironmentVariable("JAVA_HOME_${DefaultJavaVersion}_$(Get-Arch 'X64' 'arm64')")
    ...
    It "Java <Version>" -TestCases $testCases {
        $javaVariableValue = [System.Environment]::GetEnvironmentVariable("JAVA_HOME_${Version}_$(Get-Arch 'X64' 'arm64')")
