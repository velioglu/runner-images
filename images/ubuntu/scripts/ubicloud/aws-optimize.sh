...
apt-get purge plymouth update-notifier-common multipath-tools snapd lvm2 -y
...
# Disable snapd completely (including timers and sockets)
systemctl disable snapd.service snapd.apparmor.service snapd.refresh.timer snapd.socket snapd.seeded.service || true
systemctl disable udisks2.service || true
systemctl disable ec2-instance-connect-harvest-hostkeys.service || true
...
systemctl disable cups.service cups-browsed.service || true
